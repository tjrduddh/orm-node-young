...
//숫자를 매개변수(파라메터)로 받아서 해당값이 홀수인지 짝수인지 체크해서
//홀수이면 홀수입니다, 짝수이면 짝수입니다. 라는 문자열을 반환하는 함수
//모든 언어에서는 %는 특정값을 특정값으로 나눈 나머지값을 구할 때 사용
function checkOddOrEven(num){
    //num%2값은 죽어도 0아니면 1값이 반환됩니다. 나머지값을 나타냄

...
router.post('/create',upload.single('file'),async(req,res)=>{
    ...
    var filePath ="/upload/"+uploadFile.filename;  //서버에 실제 업로드된 물리적 파일명- 파일명 -도메인 주소가 생략된 파일링크주소
    var fileName = uploadFile.filename;  //서버에 저장된 실체 물리 파일명(파일명/확장자포험)
    ...
    //DB article_file테이블에 영구적으로 저장처리한다.
    var file = {
    ...
    //파일 정보를 article_file테이블에 저장하고 저장된 값을 다시 반환받는다.

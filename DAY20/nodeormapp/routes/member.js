// 사용자정보 처리를 위한 웹페이지 요청과 응답처리 전용 라우터 파일
...
router.post('/entry', async(req, res, next)=> {
    ...
    //step2: 데이터베이스에 members테이블 데이터를 저장한다
    ...
    //db.Member.create()는 ORM프레임워크에 의해서 백엔드에서
    //INSERT INTO members(email,password,createdAt)Values('사용자가 입력한 메일주소','암호',now());SQL쿼리가 만들어져서
